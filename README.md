...
- **app/** - Python server and instructions for setting up Python environment can be found in the [README](https://github.com/bilkentaudiodev/Wwise-MCP/blob/main/app/README.md)
